...
List<OnbordingData> getOnbordingData(BuildContext context) {
  final List<OnbordingData> list = [
    OnbordingData(
      image: AssetImage("images/SS-1.png"),
      titleText: Text(
        AppLocalizations.of(context)!.firstOBtitle, 
          style: TextStyle(fontFamily: 'GoogleSans-Bold', fontSize: 24, color: Color(0xFF00B27D))
      ),
      descText: Text(
        AppLocalizations.of(context)!.firstOBdesc, 
        textAlign: TextAlign.center, 
        style: TextStyle(fontFamily: 'GoogleSans-Regular', fontSize: 16, color: Colors.black)
      ),
    ),
    OnbordingData(
      image: AssetImage("images/SS-2.png"),
      titleText: Text(
      ...
      descText: Text(
        ...
        textAlign: TextAlign.center, style: TextStyle(fontFamily: 'GoogleSans-Regular', fontSize: 16, color: Colors.black)
      ),
    ),
    OnbordingData(
      image: AssetImage("images/SS-3.png"),
      titleText: Text(
