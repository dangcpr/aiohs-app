...
class _BottomEditNamePhoneState extends State<BottomEditNamePhone> {
  ...
  Widget build(BuildContext context) {
    //nameController.text = context.read<SaveAddressCubit>().state!.name!;
    //phoneController.text = context.read<SaveAddressCubit>().state!.phone!;
    return Container(
              ...
              child: ButtonGreenApp(
                ...
                onPressed: () {
                  if (_formKey.currentState!.validate()) {
                    ...
                    context.read<SaveAddressCubit>().changeNamePhone(
                          nameController.text,
