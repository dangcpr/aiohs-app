...
class PickReceiveDate extends StatefulWidget {
  const PickReceiveDate({super.key, required this.isDarkMode});

  final bool isDarkMode;

  @override
  State<PickReceiveDate> createState() => _PickReceiveDateState();
}

class _PickReceiveDateState extends State<PickReceiveDate> {
  final items =
              ...
              children: [
                ChoiceChip(
                  ...
                  onSelected: (bool selected) {
                    ...
                    context.read<SaveInfoLaundryCubit>().updateReceiveDate(items[index]);
