...
class AnimatedContanierTreoTuongCustom extends StatefulWidget {
  const AnimatedContanierTreoTuongCustom({super.key, required this.text});

  final String text;

  @override
  State<AnimatedContanierTreoTuongCustom> createState() =>
      _AnimatedContanierTreoTuongCustomState();
}

class _AnimatedContanierTreoTuongCustomState
    extends State<AnimatedContanierTreoTuongCustom> {
  bool select = false;
  int countHasGas = 0;
  int count = 1;
  late Details detail;
