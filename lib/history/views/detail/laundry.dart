...
class LaundryHistoryDetail extends StatefulWidget {
  const LaundryHistoryDetail({super.key, required this.order});

  final LaundryHistory order;

  @override
  State<LaundryHistoryDetail> createState() => _LaundryHistoryDetailState();
}

class _LaundryHistoryDetailState extends State<LaundryHistoryDetail> {
  double star = 3;
